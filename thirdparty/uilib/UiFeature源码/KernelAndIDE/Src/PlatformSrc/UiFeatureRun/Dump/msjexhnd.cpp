...
//#ifndef _DEBUG
	{
		...
		GetLocalTime(&tm);
		char str[MAX_PATH] = { 0 };
		sprintf_s(str, sizeof(str), "%s%s%04d%02d%02d%02d%02d%02d%03d.dmp", szPath, "(UiFeatureRun.exe)", tm.wYear, tm.wMonth, tm.wDay, tm.wHour, tm.wMinute, tm.wSecond, tm.wMilliseconds);
		LOGINFOITEM li = { 0 };
