...
// 缩略图的支持
void CBMDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
	// 修改此代码以绘制文档数据
...
// 搜索处理程序的支持
void CBMDoc::InitializeSearchContent()
{
...
void CBMDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
