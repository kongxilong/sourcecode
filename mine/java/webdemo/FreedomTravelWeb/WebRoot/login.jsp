...
swfobject.embedSWF("cu3er.swf", "cu3er_swf", "480", "380", "9", flashvars, params, attributes);
</script> 
<object type="application/x-shockwave-flash" data="cu3er.swf" width="480" height="380" id="cu3er_swf" style="visibility: visible;">
<param name="id" value="slider">
<param name="flashvars" value="allowscriptaccess=always&amp;allownetworking=all&amp;wmode=transparent">
</object>        
