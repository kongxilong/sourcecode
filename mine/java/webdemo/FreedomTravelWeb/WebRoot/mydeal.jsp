	...
	<head>
		...
		<style type="text/css">
     	...
     	#ibanner_btn .current { height:28px; border:1px solid #FF5300; color:#FF5300; font-size:28px; line-height:28px; }
		  .lan{width:1000px;height:428px;margin:20px auto;font-size:16px;font-family:"微软雅黑";}
		  .cart-table-th{width:1000px;height:30px;background: #e2f5f5;padding-top: 4px;overflow: hidden;display: block;
										-webkit-border-radius: 3px;border-radius: 3px;margin-bottom: 20px;font-size: 12px;color: #696969;
										border-top:3px solid #a7cbff;}
		  .wp{width:1000px;height:30px;margin: 0 auto;line-height: 30px;}
		  .th-chk{width:60px;height:30px;float:left;text-align: left}
		  .select-all{width:59px;height:30px;float:left;cursor: pointer;_margin-top: 6px}
		  .s-checkbox{display: inline-block;width: 15px;height: 15px;background-position: 0 -31px;vertical-align: middle;cursor: pointer;}
		  ...
		  .shoplist{width:750px;height:400px;}
		  .shopone{width:750px;height:200px;}
		  .shop-info{width:950px;height:20px;font:12px;color: #696969;}
		  .icon{display: inline-block;vertical-align: middle;margin-right: 6px;}
		  .content{width:950px;height:95px;margin:8px 0 0 0;background: #e2f5f5;list-style: none;font-size: 12px;color: #696969;}
        ...
        .amount a:hover { border-color: red;}
			...
			.caozuo{width:110px;height:90px;text-align:center;line-height:90px;float:left;}
			.xian{width:1205px;height:5px;margin:0px auto;border-top:5px solid #004a80;}
		  .button{width:1000px;height:50px;margin:10px auto;}
		</style>
...
addLoadEvent(iBanner);
  ...
  <body>
                        ...
                        <div class="wp">
                            <div class="th-chk">
                            	<div id="J_SelectAll1" class="select-all">
                            		...
                            		<span class="s-checkbox"><input type="checkbox" /></span>&nbsp;全选
                            	</div>
                            </div>
       ...
       <div class="shoplist"> 
        <s:iterator value="dealList" id="dealTemp" ><!-- list -->
        
        
        <form action="submitDeal.action?deal.dealId=<s:property value="#dealTemp.dealId"/>" method="post">
        
        
        <div class=shopone>
       		<div class="shop-info">
       			<span class="s-checkbox"></span><input type="checkbox" />
       			&nbsp;&nbsp;<span class="icon"></span>
       			
       			卖家：<a href="#" target="_blank" title="" class="J_MakePoint" data-point="tbcart.8.15"
       		   ...
       		   <ul class="content"> 
       		   	<li class="td-chk">
       		   		 <div class="inner">
       		   		 	<span class="s-checkbox "><input type="checkbox" onclick="" /></span>
       		   		 </div> 
       		   	</li>
       		   		  ...
       		   		  <div class="item-pic">
       		   			...
       		   			<div class="item-info"> 
       		   				<a href="#" style="color:#696969;text-decoration:none" onMouseOver="this.style.color='red'" onMouseOut="this.style.color='#696969'">
       		   					路线名称：<s:property value="#dealTemp.routeName"/></a>  
       		   		  </div>
       		   		  <div class="jsc">
       		   		  	<a href="#" onclick="addFavorite();" style="margin:0 2px 0 0px;" >
       		   	...
       		   	<li class="td-info"> 
       		   		<div class="item-props">
       		   			...
       		   			<p class="sku-line">订单编号：<s:property value="#dealTemp.dealId"/></p>
       		   			 
       		   		</div> 
       		   	</li>
       		   	<li class="td-price"> 
       		   		<div class="item-price"><s:property value="#deal.marketPrice"/></div> 
       		   	</li>
       		   	<li class="td-amount"> 
       		   		 <div class="amount"> 
                            	  	<a href="#" id="minus">-</a>
       													 <input type="text" id="text" name="deal.dealNum" value="1" data-max='5' data-min='0' 
       		   	...
       		   	<input type="submit" value="提交订单" style="width:150px;height:40px;font-size:25px;color:#ffffff;background:#f7941d;border:none;border-radius:8px"/> 		  
       		   	</li>
       	      </ul>
       	      <div class="button">
		   	  <div class="bnt" style="width:150px;height:40px;float:right">
