...
<table width="1007" border="1"  bordercolor="#979797"align="center" cellpadding="1" cellspacing="0" >
  <tr align="center" bgcolor=#ECFFFF>
    ...
    <td width="57">交通</td>
    <td width="78">天数</td>
    <td width="103">发团周期</td>
    <td width="121">截止时间</td>
    <td width="109">市场价格</td>
    <td width="87">数量</td>
    <td width="89">详细</td>
  </tr>
  ...
  <tr>
   	...
   	<td><s:a href="routeDetail.action?route.routeId=%{#route.routeId}" onclick="return routeDetail();">详细</s:a></td>
  </tr>
  </s:iterator>
  <TR>
    ...
    <s:if test="page.hasPrePage">
		<s:url var="firstPage" action="showRouteAdd.action">
		<s:param name="page.currentPage" value="1"></s:param>
		</s:url>
		<s:a href="%{firstPage}">首页</s:a>
		<s:url var="prePage" action="showRouteAdd.action">
	...
	<s:if test="page.hasNextPage">
		<s:url var="nextPage" action="showRouteAdd.action">
		<s:param name="page.currentPage" value="page.currentPage+1"></s:param>
		</s:url>
		<s:a href="%{nextPage}">下一页</s:a>
		<s:url var="lastPage" action="showRouteAdd.action">
